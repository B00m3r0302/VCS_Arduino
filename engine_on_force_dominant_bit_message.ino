...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    for (unsigned long long i = 0; i <= 9999999999999999; i++) {
      ...
      // Send message with dominant bits after the "#" sign
      char dominantMessage[] = "005#FFFFFFFFFFFFFFFF"; // Dominant bits message
      CAN.sendMsgBuf(0x005, 0, strlen(dominantMessage), (byte*)dominantMessage); // Convert message to byte array
